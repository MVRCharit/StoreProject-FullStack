...
export const pendingCompanies = async (req, res) => {
    try {
...
export const approveCompanies = async (req, res) => {
    try {
...
export const rejectCompanies = async (req, res) => {
    try {
...
export const signup = async (req, res) => {
    try {
        ...
        const id = await Service.signup(name, email, password, role, role === "company" ? { companyName, location, type, establishedYear } : undefined);
...
export const getActiveUsers = async (req, res) => {
    try {
        ...
        const emails = keys.map((key) => key.replace("active:", ""));
...
*/
export const logFraudAttempt = async (req, res) => {
    try {
