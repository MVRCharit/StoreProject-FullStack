...
signup, login, 
// ADMIN
getUsers, getCompanies, deleteUser, deleteCompany, blockUser, unblockUser, blockCompany, unblockCompany, pendingCompanies, approveCompanies, rejectCompanies, pendingProducts, approveProduct, rejectProduct, getActiveUsers, 
// COMPANY
getCompany, 
// USER
getUser, logFraudAttempt } from "../controllers/controller.js";
import { createProduct, getCompanyProducts, updateProduct, deleteProduct, getCompanyProfile, updateCompany, } from "../controllers/companyControllers.js";
import { getProfile, updateProfile, getProducts, getCart, addToCart, updateCart, deleteCart, checkout, buyAgain, setPaymentPin, getOrders, canBuyAgain, downloadInvoice } from "../controllers/userControllers.js";
...
router.get("/debug-admin", async (req, res) => {
    const [rows] = await db.execute("SELECT email, password, active, role FROM users WHERE email = 'admin@gmail.com'");
    const user = rows[0];
